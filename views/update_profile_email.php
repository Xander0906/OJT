    ...
    <div class="row mx-auto mt-2">
        <form method="post" action="../actions/update_profile.php">
            <div class="form-group text-start mb-2">
                ...
                <div class="d-flex">
                    <i class="fa fa-envelope position-absolute ms-2 pe-1 border-end align-self-center"></i>
                    <input class="form-control text-indent" name="email" value="<?php echo $_SESSION['email']; ?>" placeholder="Enter your new email" />
