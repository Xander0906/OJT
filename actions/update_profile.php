...
if (isset($_POST['update_name'])) :
    if ($_SERVER['REQUEST_METHOD'] === 'POST') { //check if the method is post
        ...
        if (empty($errors)) { //check if the errors is empty
            ...
            redirect('update_profile_name', $errors); //shortcut for header('location:register.php?errors=$errors');
        }
    }
endif;
...
if (isset($_POST['update_username'])) :
    if ($_SERVER['REQUEST_METHOD'] === 'POST') { //check if the method is post
        ...
        if (empty($errors)) { //check if the errors is empty
            ...
            redirect('update_profile_username', $errors); //shortcut for header('location:register.php?errors=$errors');
        }
    }
endif;
...
if (isset($_POST['update_email'])) :
    if ($_SERVER['REQUEST_METHOD'] === 'POST') { //check if the method is post
        ...
        if (empty($errors)) { //check if the errors is empty
            ...
            redirect('update_profile_email', $errors); //shortcut for header('location:register.php?errors=$errors');
        }
    }
endif;
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') { //check if the method is post
        ...
        if (empty($errors)) { //check if the errors is empty
            ...
            if (password_verify($current_pass, $password['password'])) {
                ...
                redirect('update_profile_password', $errors);
            }
        } else {
            redirect('update_profile_password', $errors); //shortcut for header('location:register.php?errors=$errors');
        }
    }
endif;
